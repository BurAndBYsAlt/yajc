            ...
            const i = {
                en: {
                    ...
                    POST_GAME: {
                        ...
                        BUTTON_SAME_PLAYERS: "Этими Игроками",
                        BUTTON_NEW_PLAYERS: "Новыми Игроками"
                    },
                    TUTORIAL: {
                    ...
                    UGC: {
                        ...
                        INSTRUCTION: {
                            ...
                            TOGGLE_VISIBILITY: "нажмите чтобы показать/скрыть вопросы",
                            WRITE: "напишите вопрос"
                        },
                        WARNING: {
                            DELETE: "Вы уверены что хотите удалить этот эпизод?",
                            TOS: "Делясь контентом, вы соглашаетесь с нашими  [tos]Условия предоставления услуг[/tos]",
        ...
        97608: (e, t, a) => {
            ...
            const h = {
                en: {
                    ...
                    SUBMIT_JOIN_AUDIENCE: "ЗАЙТИ ЗА ЗРИТЕЛЕЙ",
                    SUBMIT_RECONNECT: "ПЕРЕЗАЙТИ",
                    SUBMIT_TWITCH_LOGIN: "ЗАЙТИ С TWITCH",
                    TOS_WARNING: "ДАННЫЙ КЛИЕНТ ПРЕДНАЗНАЧЕН ТОЛЬКО ДЛЯ ТЕСТОВ, ИГРАТЬ НА НЕМ КАК НА ОСНОВНОМ НЕ НАДО!",
                    ...
                    STRING_CENSOR_INFO: "нажмите <span class='censor-button-image censor-button-black'></span> чтобы подвергнуть игрока цензуре до конца игры, удалив его ответы, имя и аватар (это довольно жестоко)",
                    STRING_SKIP: "пропустить!",
                    STRING_THANK_YOU: "спасибо за рисунки",
                    STRING_DRAWING_OVER: "время рисования окончено!",
                    STRING_CENSOR_LIE_CONFIRM: "это удалит запись этого игрока и все последующие записи и будущие рисунки. вы уверены?",
                    STRING_YES: "Yes",
                    STRING_NO: "No",
                    ...
                    STRING_AUTHOR_MESSAGE_6: "Ты нарисовал это.<br>Наслаждайся этим моментом.",
                    STRING_AUTHOR_MESSAGE_7: "Ты нарисовал это.<br>Слишком поздно это менять.",
                    ...
                    STRING_AUTHOR_MESSAGE_16: "Ты нарисовал это.<br> это.<br>Радуйтесь этому так хорошо, как только можете.",
                    ...
                    STRING_ERROR_INVALID_ROOM_CODE: "Недопустимый код комнаты",
                    STRING_ERROR_UNABLE_TO_JOIN: "Не удается подключиться к серверу Jackbox Games. Обычно это происходит из-за блокировщиков рекламы или расширений конфиденциальности.",
                    STRING_ERROR_WEBSOCKETS_REQUIRED: "Веб-сайты не поддерживаются в вашем браузере".,
                    STRING_ERROR_INVALID_APP_ID: "Недопустимый идентификатор приложения для комнаты: ",
                    ...
                    STRING_STYLE_WARNING: "[b]ВНИМАНИЕ:[/b] Ваш браузер, похоже, немного устарел, и у него будут некоторые проблемы с отображением этой игры.",
                    STRING_NAME: "ИМЯ",
                    ...
                    ERROR_UNSUPPORTED_WEBSOCKETS: "WebSockets не поддерживаются в вашем браузере.",
                    ERROR_ROOM_FULL: "Игра заполнена",
                    ERROR_AUDIENCE_FULL: "Аудитория заполнена",
                    ERROR_INVALID_ROOMCODE: "Неверный код комнаты",
                    ERROR_UNABLE_TO_CONNECT: "Невозможно подключиться к подключитесь к серверу Jackbox Games. Обычно это происходит из-за блокировщиков рекламы или расширений конфиденциальности.",
                    ...
                    STRING_ERROR_TWITCH_COOKIES: "Для входа в Twitch требуются файлы cookie",
                    STRING_ERROR_GAME_UNSUPPORTED: "Эта игра не поддерживается в этом браузере.",
                    STRING_ERROR_REQUIRES_TWITCH_LOGIN: "Для игры требуется вход в Twitch",
                    STRING_ERROR_ROOM_IS_LOCKED: "Игра заблокирована",
                    STRING_ERROR_INCORRECT_PASSWORD: "Неверный пароль",
                    STRING_ERROR_GENERIC: "Ошибка при присоединении к этой игре",
                    STRING_ERROR_CONNECTION: "Ошибка подключения",
                    STRING_ERROR_FILTER_NAME: "В этой игре включены фильтры ненормативной лексики. Пожалуйста, выбери другое имя".
                },
                fr: {
            ...
            var D = function() {
                ...
                return i("div", {
                    ...
                    staticClass: "contain"
                }, [i("p", [i("span", [e._v("Вы уверены?")]), e._v("\n                    Это действие удалит игру"), i("br"), e._v("из списка предыдущих игр.\n                ")]), e._v(" "), i("button", {
            ...
            var j = function() {
                ...
                return i("div", {
                    ...
                    staticClass: "subtext"
                }, [e._v("\n        Ее играем сейчас, подожди релиза\n    ")]), e._v(" "), i("div", {
                    staticClass: "actions"
                }, [i("button", {
                    on: {
                        click: function(t) {
            ...
            const L = r().extend({
                ...
                computed: {
                    ...
                    name() {
                        var e, t;
                        return this.showConfirm ? "Вы уверены?" : this.isManaging ? "Удалить игру?" : null !== (t = null === (e = this.config) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : ""
                    },
                    imageClasses() {
                        var e;
